...
<div class="container detailed" >
    <strong style="font-size: 30px; margin:20px; display: block;">影城介绍</strong>
    <div class="container" style="margin-top: 30px; margin-left: 50px; line-height: 30px;font-size: 16px;">
        <p>主要不负责人:魏伟滔</p>
        <p>地址:广州现代信息工程职业技术学院(北校区)5#425</p>
        <img src="${pageContext.request.contextPath}/img/di.png" />
    </div>
